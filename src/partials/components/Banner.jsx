  ...
  return (
    <div className="px-4 py-10 md:px-6 md:py-12 lg:px-38 lg:py-16 mb-8 bg-gradient-to-t from-white to-gray-50 rounded-lg flex flex-col md:flex-row ">
      <div className="md:w-1/2 flex flex-col justify-center pr-0 md:pr-8">
        <div className="bg-blue-100 font-semibold mt-15 lg:mt-0 lg:mb-10 p-2 rounded-2xl text-blue-400 w-fit flex items-center ">
          <FaDotCircle className='mr-2' /> Affiliate Tracking CRM Solution
        </div>
        <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
          We provide the <span className="text-blue-500">best digital </span>services
        </h1>
  ...
  <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-5 md:p-6 relative z-10">
    ...
    <div className="flex items-center justify-between mt-2">
      <div className="w-full bg-gray-300 rounded-full h-2 sm:h-2.5 mx-2">
        <div className="bg-blue-500 h-2 sm:h-2.5 rounded-full" style={{ width: '98%' }}></div>
      </div>
    </div>
